...
export interface CopyableCellProps extends Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, "onCopy"> {
    value: string | number;
...
export function CopyableCell({
    ...
    return (
        <button
            ...
            title={tooltip}
            className={cn(
                "group inline-flex items-center gap-2 px-2 py-1 -mx-2 -my-1 rounded-md transition-all duration-200 hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 cursor-pointer",
                className
            )}
            {...props}
        >
